...
#include "/home/csse3010/csse3010/mylib/lta1000g/s4433912_hal_lta1000g.h"
#include "/home/csse3010/csse3010/mylib/pb/s4433912_hal_pb.h"
...
// volatile int pin_set[10] = {GPIO_PIN_RESET, GPIO_PIN_RESET, GPIO_PIN_RESET, GPIO_PIN_RESET, GPIO_PIN_RESET,
...
void main(void)  {
    ...
    while (1) {		
		...
		debug_printf("XENON cnt: %d  PB cnt: %d Tick:%d\n\r", xenon_event_cnt, pb_event_cnt, HAL_GetTick());
